...
if(${BUILD_TARGET} MATCHES STM32H747I_DISCO)
    ...
    if((${BUILD_CONTEXT} MATCHES .*CM7.*) OR (NOT DEFINED BUILD_CONTEXT))
        ...
        ExternalProject_Add(stm32-knight-touchgfx-coffee-machine-cm7
        ...
        set(ST_DUAL_CORE_CM7_PROJECT_BUILD_TARGET ${CMAKE_SOURCE_DIR}/build/cm7/build/stm32-knight-touchgfx-coffee-machine-cm7${CMAKE_EXECUTABLE_SUFFIX_CXX} CACHE FILEPATH "Path to project target")
    endif()
endif()
