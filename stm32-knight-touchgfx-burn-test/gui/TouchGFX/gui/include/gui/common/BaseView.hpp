...
template <class T>
class BaseView : public MainViewBase, public BaseViewInterface
{
public:
    BaseView() :
        ...
        onMcuLoadClicked(this, &BaseView::mcuLoadClickedHandler)
    {
        ...
        MainViewBase::add(backButton);
    }

    virtual void afterTransition()
    {
        // MainViewBase::presenter->viewStartupDone();

        // These widget must be on top and are therefore added here
        MainViewBase::add(mcuLoadArea);
        MainViewBase::add(mcuLoadSlider);
    }
...
protected:
    ...
    {
        // MainViewBase::presenter->backOptionSelected();
    }

    void mcuLoadClickedHandler(const AbstractButton& button)
    {
        // MainViewBase::presenter->mcuLoadSelected();
    }
