...
public:
    ...
    void setWidth(int16_t width) { Container::setWidth(width); text.setWidth(width); invalidate(); }
    void setHeight(int16_t height) { Container::setHeight(height); text.setHeight(height); invalidate(); }

    void setTypedText(TypedText t) { text.setTypedText(t); invalidate(); }
    void setColor(colortype c) { text.setColor(c); invalidate(); }
