#ifndef CONTENT0204_HPP
#define CONTENT0204_HPP
...
class Content0204 : public AbstractContent
{
public:
	Content0204();
	virtual ~Content0204();
...
private:
	...
	Callback<Content0204, const FadeAnimator<TextArea>& > textarea_fade_ended_callback_;
	void textareaFadeEndedHandler(const FadeAnimator<TextArea>& textarea);

	Callback<Content0204, const FadeAnimator<ButtonWithLabel>& > buttonwithlabel_fade_ended_callback_;
	void buttonwithlabelFadeEndedHandler(const FadeAnimator<ButtonWithLabel>& buttonwithlabel);

	Callback<Content0204, const FadeAnimator<Image>& > image_fade_ended_callback_;
	void imageFadeEndedHandler(const FadeAnimator<Image>& image);

	Callback<Content0204, const AbstractButton&>button_clicked_;
