#ifndef CONTENT0301_HPP
#define CONTENT0301_HPP
...
class Content0301 : public AbstractContent
{
public:
	Content0301();
	virtual ~Content0301();
...
private:		
	...
	Callback<Content0301, const FadeAnimator<TextArea>& > textarea_fade_ended_callback_;
	void textareaFadeEndedHandler(const FadeAnimator<TextArea>& textarea);

	Callback<Content0301, const FadeAnimator<ButtonWithLabel>& > buttonwithlabel_fade_ended_callback_;
	void buttonwithlabelFadeEndedHandler(const FadeAnimator<ButtonWithLabel>& buttonwithlabel);

	Callback<Content0301, const FadeAnimator<Image>& > image_fade_ended_callback_;
	void imageFadeEndedHandler(const FadeAnimator<Image>& image);

	Callback<Content0301, const AbstractButton&>button_clicked_;
