#include <gui/widgets/info/Content0302.hpp>

#include <touchgfx/Color.hpp>
#include <Bitmapdatabase.hpp>

Content0302::Content0302()	
	:
    textarea_fade_ended_callback_(this, &Content0302::textareaFadeEndedHandler),
	buttonwithlabel_fade_ended_callback_(this, &Content0302::buttonwithlabelFadeEndedHandler),
	image_fade_ended_callback_(this, &Content0302::imageFadeEndedHandler),
	button_clicked_(this, &Content0302::buttonClickedHandler)
{
}
...
void Content0302::handleTickEvent()
{
	AbstractContent::handleTickEvent();
}

void Content0302::initialize(MachineStatus *status)
{	
...
void Content0302::textareaFadeEndedHandler(const FadeAnimator<TextArea>& textarea)
{
	animation_lock_--;
}

void Content0302::buttonwithlabelFadeEndedHandler(const FadeAnimator<ButtonWithLabel>& button)
{
	animation_lock_--;
}

void Content0302::imageFadeEndedHandler(const FadeAnimator<Image>& image)
{
	animation_lock_--;
}

void Content0302::buttonClickedHandler(const AbstractButton& source)
{
	if (&ok_ == &source)
	{
...
void Content0302::eventTriggerHandler(const int source)
{
...
void Content0302::event5()
{
	AbstractContent::event5();
}

void Content0302::event6()
{
