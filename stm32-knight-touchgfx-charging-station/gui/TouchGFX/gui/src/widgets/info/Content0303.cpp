#include <gui/widgets/info/Content0303.hpp>

#include <touchgfx/Color.hpp>
#include <Bitmapdatabase.hpp>

Content0303::Content0303()	
	:
    textarea_fade_ended_callback_(this, &Content0303::textareaFadeEndedHandler),
	buttonwithlabel_fade_ended_callback_(this, &Content0303::buttonwithlabelFadeEndedHandler),
	image_fade_ended_callback_(this, &Content0303::imageFadeEndedHandler),
	button_clicked_(this, &Content0303::buttonClickedHandler)
{
}
...
void Content0303::handleTickEvent()
{
	AbstractContent::handleTickEvent();
}

void Content0303::initialize(MachineStatus *status)
{	
...
void Content0303::textareaFadeEndedHandler(const FadeAnimator<TextArea>& textarea)
{
	animation_lock_--;
}

void Content0303::buttonwithlabelFadeEndedHandler(const FadeAnimator<ButtonWithLabel>& button)
{
	animation_lock_--;
}

void Content0303::imageFadeEndedHandler(const FadeAnimator<Image>& image)
{
	animation_lock_--;
}

void Content0303::buttonClickedHandler(const AbstractButton& source)
{
	if (&ok_ == &source)
	{
...
void Content0303::eventTriggerHandler(const int source)
{
...
void Content0303::event5()
{
	AbstractContent::event5();
}

void Content0303::event6()
{
