#ifndef SLIDER_MOD_HPP
#define SLIDER_MOD_HPP
 ...
 */
class SliderMod : public Container
{
private:

	// Fixed touch point shift bug.
	const static int shift_x = 130;
...
public:
     ...
     * @see GenericCallback
     */
    void setStartValueCallback(GenericCallback< const SliderMod&, int >& callback)
    {
     ...
     * @see GenericCallback
     */
    void setStopValueCallback(GenericCallback< const SliderMod&, int >& callback)
    {
     ...
     * @see GenericCallback
     */
    void setNewValueCallback(GenericCallback< const SliderMod&, int >& callback)
    {
...
protected:
    ...
    GenericCallback< const SliderMod&, int >* startValueCallback;  ///< The start value callback (called  when an interaction with the indicator is initiated)
    GenericCallback< const SliderMod&, int >* stopValueCallback;   ///< The stop value callback (called when an interaction with the indicator ends)
    GenericCallback< const SliderMod&, int >* newValueCallback;    ///< The new value callback (called when the indicator is moved)
